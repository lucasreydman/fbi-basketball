...
const ITEMS = [
  { type: "event", label: "World Cup ’26", value: "576", change: "TEAMS" },
  { type: "rank", label: "Wemby", value: "#1", change: "—" },
  { type: "event", label: "Prize pool", value: "$11.5k+", change: "TARGET" },
  { type: "rank", label: "SGA", value: "#2", change: "▲ 1" },
  { type: "event", label: "Entry", value: "$21", change: "FEE" },
  { type: "rank", label: "Edwards", value: "#3", change: "▼ 1" },
  { type: "event", label: "Reg opens", value: "Sep 1", change: "OPENS" },
  { type: "rank", label: "Banchero", value: "#10", change: "▲ 3" },
  { type: "event", label: "Divisions", value: "48", change: "BRACKETS" },
  { type: "rank", label: "Booker", value: "#8", change: "▼ 2" },
  { type: "rank", label: "Tatum", value: "#6", change: "▲ 2" },
  { type: "event", label: "Phases", value: "3", change: "FORMAT" },
